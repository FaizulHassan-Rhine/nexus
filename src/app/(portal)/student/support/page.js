...
export default function SupportPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Support"
        description="Get help from the Nexus helpdesk — 24-hour SLA target"
      ...
      <Modal open={createOpen} onClose={() => setCreateOpen(false)} title="Create support ticket">
        <div className="space-y-4">
          ...
          <Select
            ...
            options={["Technical issue", "Application support", "Payment issue", "General inquiry", "Safety report"]}
          />
          <Select
            label="Priority"
            value={form.priority}
