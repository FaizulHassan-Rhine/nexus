...
export default function FacultySupportPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Support"
        description="Help with exchange applications, technology transfer, and grant endorsements"
      ...
      <Modal open={createOpen} onClose={() => setCreateOpen(false)} title="Create support ticket">
        <div className="space-y-4">
          ...
          <Select
            ...
            options={["Technical issue", "Exchange support", "Grant endorsement", "Technology transfer", "General inquiry"]}
          />
          <Select
            label="Priority"
            value={form.priority}
