...
export default function FacultyApplicationsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Applications" description="Timelines, university approvals, interviews, offers, contracts, and outcomes" />
            ...
            <TabPanel key={tab} value={tab}>
              {rows.length ? (
                ...
                <EmptyState
                  ...
                  description="Browse faculty opportunities and submit applications."
                />
              )}
            </TabPanel>
          );
